import {OptionGroup, OptionGroupHeaderEnd, css, readDeclarativeRegions} from '@capillaryjs/capillary-ui'
import type {CapillaryUiChild, OptionGroupBaseProps} from '@capillaryjs/capillary-ui'
...
> extends OptionGroup<TProps> {
    ...
    protected override renderOptionGroup(content: CapillaryUiChild, headerEnd: CapillaryUiChild): CapillaryUiChild {
    ...
    static override css = css`
        & > fieldset > legend > button.cap-collapse-toggle {
            display: inline-flex;
            align-items: center;
        ...
        & > fieldset > legend > button.cap-collapse-toggle:hover {
            background: var(--button-background-hover, rgba(0, 0, 0, 0.05));
        }

        & > fieldset > legend > button.cap-collapse-toggle:focus-visible {
