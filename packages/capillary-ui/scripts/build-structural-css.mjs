...
import {CapillaryUiApp} from '../src/Components/app/app.tsx'
...
import {createCapillaryUiRuntime} from '../src/runtime.ts'
...
console.log(`[capillary-ui] structural CSS: ${outputPath}`)
