...
export interface ReadDeclarativeRegionsResult<TName extends string> {
    ...
    content: readonly CapillaryUiChild[]
    /** Contents of each unique, parent-specific region marker. */
    regions: Readonly<Partial<Record<TName, readonly CapillaryUiChild[]>>>
}
...
export function readDeclarativeRegions<TName extends string>(
    ...
    const content: CapillaryUiChild[] = []
    const regions: Partial<Record<TName, readonly CapillaryUiChild[]>> = {}
