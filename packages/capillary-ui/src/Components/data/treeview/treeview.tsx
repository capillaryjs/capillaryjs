...
export class TreeView<TValue = unknown> extends Component<TreeViewProps<TValue>> {
    ...
    static css = css`
        ...
        & [role="treeitem"][aria-expanded] > cap-expander {
            cursor: pointer;
        }
...
function isExpanderTarget(target: EventTarget | null): boolean {
    return target instanceof Element && target.closest('cap-expander') != null
}
