...
import type {ComponentProps, CapillaryUiChild, LivePropContract, Ref} from '../component.js'
import {
    componentClass,
    controlId,
    createValueEmitter,
...
export interface DialogProps extends ValueControlProps<boolean>,
    ...
    title: CapillaryUiChild
    description?: CapillaryUiChild
...
export class Dialog extends Component<DialogProps> {
    ...
    render(): CapillaryUiChild {
        ...
        const {
            title,
            description,
            closeLabel = this.capillaryUiMessage('dialogCloseLabel'),
