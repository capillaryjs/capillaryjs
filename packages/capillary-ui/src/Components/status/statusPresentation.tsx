...
/** Shared structural keyframe dependency for loading-capable Capillary UI components. */
...
export class ErrorMessage extends Component<ErrorMessageProps> {
    render(): CapillaryUiChild {
        ...
        return <Host
            ...
            aria-label={message}
        >
            <cap-erroricon aria-hidden="true" />
            <cap-errortext>{message}</cap-errortext>
        </Host>
    }
    ...
    static override css = css`
        ...
        & > cap-erroricon:hover + cap-errortext,
        &:focus-visible > cap-errortext {
            visibility: visible;
            opacity: 1;
