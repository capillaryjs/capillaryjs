...
export class DatePicker extends LabeledInputControl<DatePickerProps> {
        ...
        return (
            <Host className={componentClass(this.props) || null}>
                ...
                <button
                    ...
                    tabIndex={-1}
                    aria-label={this.capillaryUiMessage('datePickerOpenCalendarLabel')}
                    onClick={() => !readOnly && !disabled && this.open(true)}
                >
                    {'▼'}
                </button>
                {this.isOpen ? (
                    <dialog
                        ...
                        role="dialog"
                        aria-modal="false"
                        aria-label={this.capillaryUiMessage('datePickerDialogLabel')}
                        open
                        ref={dialogRef}
    ...
    static override css = css`
        ...
        & > dialog .cap-calendar .cap-calendar-header {
            display: flex;
        ...
        & > dialog .cap-calendar .cap-calendar-header button {
            min-inline-size: 2em;
            min-block-size: 2em;
            padding: 0.25em;
            cursor: pointer;
        ...
        & > dialog .cap-calendar table[role="grid"] {
            border-collapse: collapse;
            width: 100%;
            font: inherit;
        }

        & > dialog .cap-calendar table[role="grid"] th,
        & > dialog .cap-calendar table[role="grid"] td {
            padding: 0.125em;
            text-align: center;
        }
        ...
        & > dialog .cap-calendar table[role="grid"] td button {
            inline-size: 2em;
            block-size: 2em;
            padding: 0;
        ...
        & > dialog .cap-calendar table[role="grid"] td button:focus-visible {
            outline: 2px solid transparent;
            outline-offset: 1px;
            box-shadow: var(--focus-ring);
        }

        & > dialog .cap-calendar table[role="grid"] td button[data-today="true"] {
            border-color: var(--palette-primary-500);
        }

        & > dialog .cap-calendar table[role="grid"] td button[data-selected="true"] {
            background: var(--palette-primary-500);
            color: var(--palette-primary-contrast);
        }

        & > dialog .cap-calendar table[role="grid"] td button:disabled,
        & > dialog .cap-calendar table[role="grid"] td button[aria-disabled="true"] {
            color: var(--input-color-disabled);
            cursor: not-allowed;
        }
