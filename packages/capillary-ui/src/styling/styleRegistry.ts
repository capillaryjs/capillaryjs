const STYLE_ATTRIBUTE = 'data-cap-structural-styles'
...
/** Create an isolated registry for a configured Capillary UI application runtime. */
export function createStyleRegistry(): StyleRegistry {
    return new StyleRegistry()
}

/** Backward-compatible structural styles for the default Capillary UI runtime. */
