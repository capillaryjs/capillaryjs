...
import type {ComponentProps, CapillaryUiChild} from '../Components/component.js'
...
export class RouteScope extends Component<RouteScopeProps> {
    ...
    initialize(): void {
        ...
        if (router == null) throw new Error('RouteScope requires a router in CapillaryUiRuntime')
